...
export const msalConfig = {
  auth: {
    ...
    authority:
      "https://login.microsoftonline.com/b41b72d0-4e9f-4c26-8a69-f949f367c91d", // Defaults to "https://login.microsoftonline.com/common"
...
export const protectedResources = {
  apiTodoList: {
    endpoint: `${process.env.REACT_APP_API_URL_PROXY}/api/todolist`,
    scopes: {
